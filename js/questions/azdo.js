    ...
    URLs: [
        {
            ...
            URL: 'https://youtu.be/JhqpF-5E10I'
        },
        {
            Title: 'Video tutorial 2',
            URL: 'https://youtu.be/H-R2bCXfz8I'
        },
        {
            Title: 'Video tutorial 3',
            URL: 'https://youtu.be/yecw2rUlywA'
        },
        {
            Title: 'Video tutorial 4',
            URL: 'https://youtu.be/MOZMw5_fBFA'
        },
        {
            Title: 'Source: opstrainerz.com',
            URL: "https://www.opstrainerz.com/blog/azure-devops-interview-questions#Experienced",
        }
    ],
    Questions: [
        [
            `Video tutorials`,
            `<iframe width="560" height="315" src="https://www.youtube.com/embed/JhqpF-5E10I" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
            
            <iframe width="560" height="315" src="https://www.youtube.com/embed/H-R2bCXfz8I" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
            
            <iframe width="560" height="315" src="https://www.youtube.com/embed/yecw2rUlywA" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
            
            <iframe width="560" height="315" src="https://www.youtube.com/embed/MOZMw5_fBFA" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>`
        ],
        [
        ...
        [
            `List out some famous tools of DevOps?`,
            `--- Jenkin
            --- Travis CI
            --- Bamboo
            --- Hudson
        ...
        [
            ...
            1. <b>Plan</b>: plan is essential for any application which requires the development, preparing plan for the process of development is the best practice.
            2. <b>Code</b>: The code of application is designed according to the needs of users.
            3. <b>Build</b>: with the help of different codes that are generated in earlier steps, the build of the application created.
            4. <b>Test</b>: Test plays an essential role in the development of the It application, which helps to test the application and it re-built the application when required.
            5. <b>Integrate</b>: It is used to collaborate the various codes, which are from multiple programers.
            6. <b>Deploy</b>: It helps for the future use by forming the environment of the cloud from the deployed codes, and it maintains continuous functioning even though the new changes take place in the website with a high traffic.
            7. <b>Operate</b>: When it is necessary operations take place on code.
            8. <b>Monitor</b>: For the customer needs, the performance of the application is monitored.`
        ],
        [
        ...
        [
            `Mention some important components of azure devops integration and the bit bucket?`,
        ...
        [
            `Describe the projects of Azure DevOps?`,
        ...
        [
            `List Out some useful tools of continuous monitoring?`,
            `--- Lansweeper
            --- Spiceworks
            --- Snort
            --- Solarwinds
        ...
        [
            `Mention the service is used to manage the Azure resources.`,
        ...
        [
            ...
            `--- <b>DevOps</b>: It is a kind of culture which helps to collaborate operation teams and the development, and makes them work simultaneously. The output of this process is continuous integration, testing, deployment, development and it scans the entire lifecycle of the software.
            --- <b>Agile</b>: It is a type of procedure of software which concentrates small, iterative, the quick delivery of the software and the feedback from users. This process displays the problems and the gaps between developers and the users. `
        ],
        [
        ...
        [
            `Mention the reasons for why should we use azure boards?`,
        ...
        [
            `Made a comparison between VSTS and Azure DevOps?`,
        ...
        [
            `Explain the roles and their use?`,
        ...
        [
            `What is the use of an active directory in Azure?`,
        ...
        [
            `How to use Azure Ad applications?`,
        ...
        [
            `Write a note on Azure service fabric.`,
        ...
        [
            `What are the restrictions for customers using managed disks?`,
